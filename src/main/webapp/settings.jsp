...
<%
    ...
    if (tenantId_settings != null && tenantId_settings > 0 && pageLevelError_settings == null) {
        ...
        if (inSetupWizardMode_JSP && isFirstWizardSettingsLoad) {
            ...
            currentOvertimeDoubleTimeThreshold = "12.0"; currentOvertimeSeventhDayEnabled = false; currentOvertimeSeventhDayOTThreshold = "8.0"; currentOvertimeSeventhDayDTThreshold = "8.0";
            try {
