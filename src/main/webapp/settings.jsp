...
<body>
    ...
    <script>
        ...
        // **FIX**: Pass the context path to a global JavaScript variable.
    ...
    <%-- The wizard navigation logic has been moved to settings.js for better practice --%>
</body>
</html>
