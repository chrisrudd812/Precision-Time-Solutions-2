...
<body>
    ...
    <% } else { %>
        <div class="wizard-header" style="background-color: #004080; color: white; padding: 15px 20px; text-align: center; margin-bottom: 20px;">
        ...
        <form id="settingsForm" onsubmit="return false;">
            ...
            <div class="setting-item">
                ...
                <div class="setting-info" style="margin-bottom: 20px;">
                    <strong>Note:</strong> Overtime rules can be complex. <a href="https://www.dol.gov/agencies/whd/minimum-wage/state" target="_blank" rel="noopener noreferrer">Click here for current Overtime rules by State <i class="fas fa-external-link-alt"></i></a>.
                </div>
    ...
    <div id="notificationModalGeneral" class="modal" style="display: none; z-index: 10005;">
