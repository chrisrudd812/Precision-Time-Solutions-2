...
<body>
    ...
    <div class="parent-container">
        ...
        <% if (pageLevelError != null && !pageLevelError.isEmpty()) { %><div class="page-message error-message" id="pageNotificationDiv_Error_Sched"><%=escapeJspHtml(pageLevelError)%></div><% } %>
        ...
        <h4 class="instruction-text" id="instructionTextH4_Scheduling"><span class="instruction-text">💡 Select a row to edit or delete</span></h4>

        <div class="content-display-area">
            <div id="reportOutput_schedules" class="table-container">
                <table id="schedulesTable" class="report-table sortable" data-initial-sort-column="0" data-initial-sort-direction="asc">
                    <thead>
                        <tr>
    ...
    <script type="text/javascript">
        ...
        window.itemJustAdded_Page = <%= scheduleJustAddedInWizard_JSP %>;
